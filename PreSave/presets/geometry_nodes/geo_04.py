...
def apply_geometry_nodes_preset(obj):
    ...
    node.inputs[1].default_value = 5.0
    ...
    node.inputs[5].default_value = 0.5458333492279053
    ...
    node.inputs[4].default_value = 2.6999998092651367

    node.inputs[5].default_value = 0.0

    node.inputs[6].default_value = 5.497786998748779

    node.inputs[7].default_value = 0.0

    node.inputs[8].default_value = False

    node.inputs[9].default_value = False
